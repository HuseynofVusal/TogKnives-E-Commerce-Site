          ...
          <div className="flex flex-wrap justify-between  gap-5">
            ...
            <div className="text-white lg:max-w-1/3 max-w-3/4 mx-auto">
              ...
              <p className="text-[12px] leading-[18px] text-justify mt-6 mb-3 text-[#dfdfdf]">
                Be first in line when we release new products. Learn everything
                we know about knives. You'll also be automatically entered into
                our rolling knife draw: each month a random winner will be sent
                a knife.
              </p>
              <div className="bg-white rounded-sm p-2">
                <form className="flex flex-col gap-2">
                  <div className="">
                    <input
                      className=" text-[#0a0a0a] font-sans px-3 py-2 w-full rounded-sm border border-gray-300 p-3 
             focus:outline-none focus:orange-500 
             focus:ring-2 focus:ring-[#e97625] 
             transition duration-300"
                  ...
                  <button
                    type="submit"
                    className="w-full group rounded-sm cursor-pointer hover:bg-[#ec7e30] bg-[#e97625]
 text-white px-3 py-3 text-center flex justify-center items-center"
                  >
                    <FaLongArrowAltRight className="text-xl group-hover:translate-x-[10px] duration-300" />
                  </button>
                </form>
              </div>
